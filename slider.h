...
#define SLIDER_X_OFFSET 10
#define SLIDER_HEIGHT	8

class Slider : public Element {
public:
	__forceinline Slider() : m_health{ false }, m_drag { false }, m_value{}, m_min{}, m_max{}, m_step{}, m_fill{}, m_precision{}, m_label{}, m_suffix{}, m_offset{} {
	...
	__forceinline void setup(const std::string& label, const std::string& file_id, float min, float max,
		bool use_label = true, int precision = 0, float value = 0.f, float step = 1.f, const std::wstring& suffix = L"", bool health = false ) {
		m_file_id   = file_id;
