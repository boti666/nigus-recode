...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flNextDecalTime;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flNextObserverInput;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flNextGuardianTooFarHurtTime;
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flGroundAccelLinearFracLastTime;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR( m_flNextDecalTime,            HASH( "DT_CSPlayer" ),             HASH( "m_flNextDecalTime" ) );
